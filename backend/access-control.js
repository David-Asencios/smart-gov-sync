...
const writableByRole = Object.freeze({
  ADMIN: new Set(["*"]),
  MESA_PARTES: new Set(["administrados", "administrados_direcciones", "expedientes_generales", "documentos_ingresados"]),
  ESPECIALISTA: new Set(["hojas_ruta_derivaciones"]),
  ARCHIVO: new Set(["hojas_ruta_derivaciones", "archivo_fisico_central", "actas_archivamiento"])
});
